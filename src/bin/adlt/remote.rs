...
// process any new msgs (or remaining) from all_msgs for this stream
fn process_stream_new_msgs(
    stream: &mut StreamContext,
    new_msgs_offset: usize,
    new_msgs: &[adlt::dlt::DltMessage],
...
mod tests {
    use super::*;
    use adlt::dlt::{DltMessage, DltStandardHeader};
    use adlt::*;
